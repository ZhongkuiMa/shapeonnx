...
class TestBinaryOpShapes:
    """Test shape inference for Add, Sub, Mul, Div across broadcasting patterns."""

    @pytest.mark.parametrize(
        ("operation", "shape1", "shape2", "expected"),
        [
            pytest.param("Add", [], [], [], id="add_scalar_plus_scalar"),
            pytest.param("Add", [1], [1], [1], id="add_1d_same_shape"),
            pytest.param("Add", [3, 4], [3, 4], [3, 4], id="add_2d_same_shape"),
            pytest.param("Add", [1, 3, 4], [1, 3, 4], [1, 3, 4], id="add_3d_same_shape"),
            pytest.param("Add", [1, 4], [3, 4], [3, 4], id="add_broadcast_first_dim"),
            pytest.param("Add", [3, 1], [3, 4], [3, 4], id="add_broadcast_second_dim"),
            pytest.param("Add", [1, 1], [3, 4], [3, 4], id="add_broadcast_both_dims"),
            pytest.param("Add", [1, 3, 1, 4], [2, 1, 5, 4], [2, 3, 5, 4], id="add_4d_complex"),
            pytest.param("Add", [], [3, 4], [3, 4], id="add_scalar_broadcast"),
            pytest.param("Sub", [3, 4], [3, 4], [3, 4], id="sub_same_shape"),
            pytest.param("Sub", [1, 4], [3, 4], [3, 4], id="sub_broadcast_first_dim"),
            pytest.param("Sub", [3, 1], [3, 4], [3, 4], id="sub_broadcast_second_dim"),
            pytest.param("Mul", [], [], [], id="mul_scalar_times_scalar"),
            pytest.param("Mul", [3, 4], [3, 4], [3, 4], id="mul_2d_same_shape"),
            pytest.param("Mul", [1, 4], [3, 4], [3, 4], id="mul_2d_broadcast"),
            pytest.param("Div", [3, 4], [3, 4], [3, 4], id="div_same_shape"),
            pytest.param("Div", [1, 4], [3, 4], [3, 4], id="div_broadcast_first_dim"),
        ],
    )
    def test_binary_op_shapes(self, operation, shape1, shape2, expected):
        """Test binary operation shape inference with broadcasting."""
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param("Add", [2, 3], [4, 5], id="incompatible_2d"),
            pytest.param("Add", [2, 3, 4], [2, 3, 5], id="incompatible_rightmost_dim"),
        ],
    )
    def test_incompatible_shapes(self, operation, shape1, shape2):
        """Test binary operation raises error for incompatible shapes."""
        ctx = ShapeInferenceContext(
            data_shapes={"a": shape1, "b": shape2},
            explicit_shapes={},
            initializers={},
